                ...
                <div className="space-y-2">
                  {formData.steps.map((step, idx) => (
                    <div key={idx} className="flex gap-2">
                      <span className="flex-shrink-0 w-8 h-8 flex items-center justify-center bg-gray-100 dark:bg-[#1e2535] text-gray-600 dark:text-gray-400 text-xs font-medium rounded-lg">
                        {idx + 1}
                      </span>
                      <input
                        type="text"
              ...
              <div>
                ...
                <div className="space-y-2">
                  {formData.common_pitfalls.map((pitfall, idx) => (
                    <div key={idx} className="flex gap-2">
                      <AlertTriangle className="w-5 h-5 text-yellow-800 flex-shrink-0 mt-2" />
                      <input
                        type="text"
                        value={pitfall}
              ...
              <div>
                ...
                <div className="space-y-2">
                  {formData.validation_criteria.map((criteria, idx) => (
                    <div key={idx} className="flex gap-2">
                      <CheckCircle className="w-5 h-5 text-green-700 flex-shrink-0 mt-2" />
                      <input
                        type="text"
                        value={criteria}
