...
import RBACManagementPage from '@/pages/RBACManagement';
...
describe('RBACManagement color-contrast', () => {
  ...
  it('passes in light theme', async () => {
    const result = await auditRoute(<MemoryRouter><RBACManagementPage /></MemoryRouter>, 'light');
    expect(result).toHaveNoViolations();
  });

  it('passes in dark theme', async () => {
    const result = await auditRoute(<MemoryRouter><RBACManagementPage /></MemoryRouter>, 'dark');
    expect(result).toHaveNoViolations();
  });
});