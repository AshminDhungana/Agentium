...
export function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        // B15: inline error banner from store `error` already surfaces this.
    };
    ...
    return (
        ...
        >
            <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                {/* B14: aria-describedby links the error region to both inputs */}
                <div>
                    <label
                        htmlFor="username"
                ...
                {/* B14: role="alert" ensures screen readers announce this automatically */}
                {error && (
                    <div
                        id="login-error"
                        role="alert"
