    ...
    return (
      <div className="space-y-4">
        ...
        <div className="
          ...
          border border-gray-200 dark:border-[#1e2535]
          rounded-lg p-6 min-h-[300px]
          text-gray-600 dark:text-gray-300
          relative overflow-hidden
        ">
          {!isDone && (
            <div className="absolute top-0 left-0 right-0 h-1 bg-indigo-500/20">
              <div className="h-full bg-indigo-500 animate-[pulse_2s_ease-in-out_infinite] w-1/3" />
            </div>
          )}
          ...
          {workflows.map((wf) => (
            <div
              ...
              className="
                ...
                border border-gray-200 dark:border-[#1e2535]
                rounded-xl p-5
                hover:border-gray-300 dark:hover:border-indigo-500/50
...
const ActivityPulse = () => (
  <div className="relative flex items-center justify-center w-12 h-12">
    <div className="absolute w-full h-full border-4 border-indigo-500 rounded-full animate-ping opacity-20" />
