...
export const CriticStatsPanel: React.FC = () => {
    ...
    if (error || !stats) {
        return (
            <p className="text-xs text-gray-600 dark:text-slate-400 py-2">{error ?? 'No data'}</p>
        );
    }
        ...
        <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
                <div className="rounded-lg border border-slate-200 dark:border-[#1e2535] bg-white dark:bg-[#0f1117] px-3 py-2">
                    <p className="text-xs text-gray-600 dark:text-slate-400">Total reviews</p>
                    <p className="text-base font-semibold text-slate-900 dark:text-white">
                        {stats.total_reviews.toLocaleString()}
                    </p>
                </div>
                <div className="rounded-lg border border-slate-200 dark:border-[#1e2535] bg-white dark:bg-[#0f1117] px-3 py-2">
                    <p className="text-xs text-gray-600 dark:text-slate-400">Approval rate</p>
